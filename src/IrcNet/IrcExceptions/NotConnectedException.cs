...
{
    /// <summary>
    /// Represents a custom exception for the SmartIrc4net library when a connection is not established but an operation requiring a connection was attempted.
    /// </summary>
    [Serializable()]
    public class NotConnectedException : ConnectionException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the NotConnectedException class with serialized data.
        /// </summary>
